...
const DATA_URL = `${import.meta.env.BASE_URL}data/graph.json?v=bulb-light-v6`
  ...
  return (
    <main className="app-shell">
      <section className="topbar">
        <div>
          <p className="eyebrow"><Sparkles size={14} /> Hermes Memory Universe 3.3</p>
          <h1>燈泡光暈星圖測試版</h1>
        </div>
      ...
      <section className="layout">
        ...
        <section className="universe-card">
          <div className="graph-toolbar">
            <span><GitBranch size={14} /> 燈泡式漸暗光暈・點擊才顯示連結・距離 +60%</span>
